import { TotalPension } from "../scripts/pension-forecast/pension-forecast.js";
import { RegularPension } from "../scripts/pension-forecast/regular-pension.js";
...
export function registerTests(runner) {
    ...
    describe("pension-forecast.js Unit Tests", () => {
    ...
    describe("pension-forecast.js Integration Tests", () => {
